...
class AppDelegate: UIResponder, UIApplicationDelegate, UNUserNotificationCenterDelegate {
    ...
    private func setStockTranslations() {
        ...
        dcContext.setStockTranslation(id: DC_STR_REMOVE_MEMBER, localizationKey: "member_x_removed")
        ...
        dcContext.setStockTranslation(id: DC_STR_CHANNEL_LEFT_BY_YOU, localizationKey: "channel_left_by_you")
        ...
        dcContext.setStockTranslation(id: DC_STR_CHAT_UNENCRYPTED_EXPLANATON, localizationKey: "chat_unencrypted_explanation")
        dcContext.setStockTranslation(id: DC_STR_OUTGOING_AUDIO_CALL, localizationKey: "audio_call")
        dcContext.setStockTranslation(id: DC_STR_OUTGOING_VIDEO_CALL, localizationKey: "video_call")
        dcContext.setStockTranslation(id: DC_STR_INCOMING_AUDIO_CALL, localizationKey: "audio_call")
