...
const IDELTACHAT_SCHEME: &str = "https://i.bmchat.example/#";
const IDELTACHAT_NOSLASH_SCHEME: &str = "https://i.bmchat.example#";
...
/// scheme: `https://i.bmchat.example[/]#FINGERPRINT&a=ADDR[&OPTIONAL_PARAMS]`
