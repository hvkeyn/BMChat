#!/usr/bin/env bash
# BMChat 2.49.43 — окончательный фикс QuoteSelectorActivity (recreate-loop). Client-only.
set -euo pipefail

VPS_HOST="5.187.4.132"
VPS_USER="root"
VPS_PASS="wog11vrtfwjuoy4uwm"
APK_NAME="BMChat-foss-debug-2.49.43.apk"
...
${SSH} "curl -sS -H 'Host: 5.187.4.132' http://127.0.0.1/update.json | head -16"
