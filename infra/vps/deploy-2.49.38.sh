#!/usr/bin/env bash
# BMChat 2.49.38 deploy: client-only release. No VPS-side service
# changes — telegram-bot-api, bmchat-tgproxy, nginx, cleanup timers
# stay exactly where 2.49.34 left them.
set -euo pipefail
...
APK_NAME="BMChat-foss-debug-2.49.38.apk"
